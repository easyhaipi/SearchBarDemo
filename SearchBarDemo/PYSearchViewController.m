...
//        [self setHotSearches:self.searchHistories];
...
- (UITableView *)baseSearchTableView
{
    if (!_baseSearchTableView) {
        CGFloat tableX = 0;
        CGFloat tableY = 15;
        CGFloat tableW = PYScreenW;
        CGFloat tableH = PYScreenW - tableY;
        UITableView *baseSearchTableView = [[UITableView alloc] initWithFrame:CGRectMake(tableX, tableY, tableW, tableH) style:UITableViewStyleGrouped];
...
//    self.showHotSearch = NO;
    ...
    titleView.py_y = 20;
    titleView.py_width = PYScreenW - titleView.py_x * 2;
    titleView.py_height = 30;
    
    CGFloat searchBarHeigth = titleView.py_height;
    CGFloat searchBarWidth = self.view.py_width - 44 - titleView.py_x * 2;

    CYSearchBar *searchBar = [[CYSearchBar alloc] initWithFrame:CGRectMake(0, 0, searchBarWidth, searchBarHeigth)];
    ...
    // 取消按钮
    CGFloat cancelHeight = titleView.py_height;
    CGFloat cancelWidth = titleView.py_height + 10;
    UIButton *cancelBtn = [UIButton setButtonAttributeWithFrame:CGRectMake(CGRectGetMaxX(searchBar.frame), 0, cancelWidth, cancelHeight) title:@"取消" font:13 titleColor:[UIColor blackColor]];
...
- (void)setOptionsArray:(NSArray *)optionsArray
{
    ...
    self.searchBar.optionsArray = optionsArray;
}
